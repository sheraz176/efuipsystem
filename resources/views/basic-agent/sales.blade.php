              ...
              <div class="row mb-5">
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                      ...
                      <a href="{{ route('basic-agent.transaction') }}" id="transactionpage" class="btn btn-lg btn-success">Start Subscription/Deduction</a>
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card text-center">
                    ...
                    <div class="card-body">
                      ...
                      <a href="{{ route('basic-agent.sucesssales') }}" class="btn btn-lg btn-primary">Check Now</a>
                    </div>
                    <div class="card-footer text-muted">Wanted To Know More</div>
                  </div>
                </div>
